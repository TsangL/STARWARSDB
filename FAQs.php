...
<html lang="en">
    ...
    <body>
        ...
        <div id="box">
            <br>
            <div id="partbox">FAQ's</div>
            <div class="normal">Q. Why is this site even in existance?</div>
            <div class="italics">A. Because cookies are so darned good to eat!</div>
            <br>
            <br>
            <div class="normal">Q. I like cookies, does this mean I would like cookie cutters?</div>
            <div class="italics">A. Certainly! Cookies are great, so that must mean cookie cutters are even better!</div>
        </div>
        <br>
        <br>
        <br>
